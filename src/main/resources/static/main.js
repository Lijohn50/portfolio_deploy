(function () {
  ...
  // Message form — shows a confirmation only, does not open any email client
  const messageForm = document.getElementById("message-form");
  const messageNote = document.getElementById("message-form-note");
  if (messageForm && messageNote) {
    messageForm.addEventListener("submit", (e) => {
      ...
      if (!name || !email || !body) {
        ...
        messageNote.textContent = "Please fill in all fields before sending.";
        messageNote.classList.add("is-error");
      }
    });
  }
})();
